print("Reading files")
bim <- read.table("/group/ober-resources/users/smozaffari/Prediction/data/test/annotated_qc.bim")
IDxSNP2 <- read.table("/group/ober-resources/users/smozaffari/Prediction/data/test/qcfiles_rsids.ped")
ID < SNPxID[,2]
IDxSNP <- SNPxID[,-c(1:6)]
SNPxID <- t(IDxSNP)
SNPlist <- read.table("/group/ober-resources/users/smozaffari/Prediction/data/test/rslist.txt")
